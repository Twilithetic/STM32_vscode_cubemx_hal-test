...
#define AS5600_SDA_Clr()  HAL_GPIO_WritePin(AS5600_SDA_PORT,AS5600_SCL_PIN, RESET)
#define AS5600_SDA_Set()  HAL_GPIO_WritePin(AS5600_SDA_PORT,AS5600_SCL_PIN, SET)
#define AS5600_SDA_Read()  HAL_GPIO_ReadPin(AS5600_SDA_PORT,AS5600_SCL_PIN)
